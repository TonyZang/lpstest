...
func main() {
	...
	if len(inputPath) == 0 {
		...
		if !isDir(outputPath) {
			log.Fatalf("ERROR: The output path '%s' is not a directory!", inputPath)
		}
	}
...
// 生成源码文件的头部
func (g *Generator) genHander(pkgName string) {
...
func (g *Generator) format() ([]byte, error) {
	...
	formateSrc, err := format.Source(originalSrc)
	if err != nil {
	...
	return formateSrc, nil
}

func Title(str string) string {
	caser := cases.Title(language.English)
	ouput := caser.String(str)
	return ouput
}
